    ...
    switch (variant) {
      case ButtonVariant.defaultVariant:
        return baseStyle.copyWith(
          backgroundColor:
              WidgetStateProperty.all<Color>(ThemeColors.buttonPrimary),
          foregroundColor: WidgetStateProperty.all<Color>(ThemeColors.white),
          overlayColor: WidgetStateProperty.all<Color>(
              ThemeColors.primary.withOpacity(0.8)),
        );
      case ButtonVariant.destructive:
        return baseStyle.copyWith(
          backgroundColor: WidgetStateProperty.all<Color>(ThemeColors.error),
          foregroundColor: WidgetStateProperty.all<Color>(ThemeColors.white),
          overlayColor: WidgetStateProperty.all<Color>(
      ...
      case ButtonVariant.outline:
        return baseStyle.copyWith(
          backgroundColor: WidgetStateProperty.all<Color>(ThemeColors.white),
      ...
      case ButtonVariant.secondary:
        return baseStyle.copyWith(
          backgroundColor: WidgetStateProperty.all<Color>(ThemeColors.white),
          foregroundColor: WidgetStateProperty.all<Color>(ThemeColors.black),
          overlayColor: WidgetStateProperty.all<Color>(
      ...
      case ButtonVariant.ghost:
        return baseStyle.copyWith(
          ...
          foregroundColor: WidgetStateProperty.all<Color>(ThemeColors.white),
          elevation: WidgetStateProperty.all<double>(0),
          overlayColor: WidgetStateProperty.all<Color>(ThemeColors.textPrimary),
        );
      case ButtonVariant.link:
        return baseStyle.copyWith(
          backgroundColor: WidgetStateProperty.all<Color>(ThemeColors.white),
